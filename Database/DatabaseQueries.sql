...
-- 5. (UserRoles) - ADD THIS STEP BEFORE UserAccounts INSERT
...
INSERT INTO [LeaveTypes] ([id], [typeName], [isPaid]) VALUES 

(NEWID(), 'Annual Leave', 1),       -- إجازة سنوية (مدفوعة - 21 يوم)

(NEWID(), 'Sick Leave', 1),         -- إجازة مرضية (مدفوعة - 14 يوم)

(NEWID(), 'Unpaid Leave', 0),       -- إجازة بدون راتب (غير مدفوعة - 30 يوم)

(NEWID(), 'Maternity Leave', 1),    -- إجازة أمومة (مدفوعة - 90 يوم)

(NEWID(), 'Paternity Leave', 1),     -- إجازة أبوة (مدفوعة - 3 أيام)

(NEWID(), 'Marriage Leave', 1),      -- إجازة زواج (مدفوعة - 5 أيام)

(NEWID(), 'Bereavement Leave', 1);   -- إجازة وفاة (مدفوعة - 3 أيام)
